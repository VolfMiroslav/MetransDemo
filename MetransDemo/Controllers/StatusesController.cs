...
namespace MetransDemo.Controllers
{
    public class StatusesController : Controller
    {
        ...
        public StatusesController(MetransDemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code")] Status status)
        {
            if (id != status.Id)
            {
                return NotFound();
